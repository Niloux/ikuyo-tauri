<template>
  <button
    ...
    :class="[sizeClass, { subscribed: isSubscribed, loading: subscriptionLoading }]"
  ...
  >
    ...
    <span v-else>
      ...
      <span v-if="showText" class="btn-text">{{ isSubscribed ? '已订阅' : '订阅' }}</span>
    </span>
  </button>
</template>
...
const sizeClass = computed(() => {
  switch (props.size) {
    case 'small': return 'subscription-btn--small'
    case 'large': return 'subscription-btn--large'
    default: return 'subscription-btn--medium'
  }
})
