...
import type {
  DownloadTask,
  ProgressUpdate,
} from "@/services/download/downloadTypes";
...
let lastMissingProgress:
  | import("@/services/download/downloadTypes").ProgressUpdate
  | null = null;
...
export const useDownloadStore = defineStore("download", {
  ...
  actions: {
    async init() {
      if (hasInit) return;
      hasInit = true;
      await listen<import("@/services/download/downloadTypes").ProgressUpdate>(
        "download_progress",
        (event) => {
    ...
    updateProgress(
      progress: import("@/services/download/downloadTypes").ProgressUpdate,
    ) {
    ...
    async startDownload(
      task: import("@/services/download/downloadTypes").StartDownloadTask,
    ) {
